...
<div id="locationField">
  <label class="inputLabel" for="autoCompleteCountry"><?php echo ENTRY_COUNTRY; ?></label>
<?php echo autoCompleteCountryList('gaa_country_id', $selected_country, 'id="autoCompleteCountry" '); ?>
<br />
<br class="clearBoth" />
  <label class="inputLabel" for="autocomplete"><?php echo GAA_ENTRY_ADDRESS; ?></label>
  <?php echo zen_draw_input_field('GoogleAutoAddress', '', 'id="autocomplete" placeholder="' . GAA_PLACEHOLDER_AUTOCOMPLETE_ADDRESS .'" onFocus="geolocate()"'); ?>
  <a href="#" id="billing_hide_detailed_address"><?php echo GAA_HIDE_DETAILS; ?></a>
...
<?php echo zen_draw_input_field('postcode', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_postcode', '40') . ' id="postal_code" placeholder="' . ENTRY_POST_CODE_TEXT . '"' . ((int)ENTRY_POSTCODE_MIN_LENGTH > 0 ? ' required' : '')
); ?>
<br class="clearBoth" />
